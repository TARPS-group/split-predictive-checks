...
#
# Computes RMSE between observed values y and predictions yhat.
#
# Args:
#   y    : numeric vector of observed outcomes
#   yhat : numeric vector or matrix of predictions
#
# Returns:
#   Numeric scalar RMSE
# ------------------------------------------------------------
...
#
# Computes a two-sided Bayesian posterior predictive p-value.
#
# Args:
#   model     : fitted brms model
#   data      : dataset used for evaluation
#   test_stat : function (e.g. mean, sd, var) or "MSE"
#
# Returns:
#   List with:
#     pval  : two-sided Bayesian p-value
...
# ------------------------------------------------------------
# Sample Predictive Check (Held-Out Evaluation)
#
# Computes predictive p-value on held-out data.
# Allows new group levels for hierarchical models.
#
# Args:
#   model     : fitted brms model (trained on training data)
#   test_data : held-out dataset
#   test_stat : function or "MSE"
#
# Returns:
#   List with:
#     pval  : two-sided Bayesian p-value
#     rmse  : predictive RMSE on held-out data
# ------------------------------------------------------------
...
#
# Computes p-value using draws from the prior predictive
# distribution (no data conditioning).
#
# Args:
#   model     : brms model with priors defined
#   data      : dataset for generating predictions
#   test_stat : function or "MSE"
#
# Returns:
#   Two-sided prior predictive p-value
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Hjort et al. Post-Processed PPC
#
# Implements post-processing via empirical CDF of
# posterior predictive discrepancy values.
#
# Args:
#   model     : fitted brms model
...
#
# Returns:
#   Two-sided post-processed p-value
# ------------------------------------------------------------
...
```{r}
# ------------------------------------------------------------
# Time Generalization Model
#
# Goal:
#   Evaluate predictive performance across time.
#
# Strategy:
#   - Encode month cyclically using sine/cosine terms
#   - Fit model on full data for PPC
#   - Hold out December for SPC evaluation
# ------------------------------------------------------------
...
```{r}
# ------------------------------------------------------------
# Destination Generalization Model
#
# Goal:
#   Evaluate predictive performance on unseen airports.
#
# Strategy:
#   - Hierarchical random intercept for destination
#   - Hold out a specific airport (AKL)
#   - Compare PPC vs SPC vs Prior vs Hjort PPC
# ------------------------------------------------------------
