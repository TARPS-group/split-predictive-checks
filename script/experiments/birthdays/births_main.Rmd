...
source(root("spc/experiments/birthdays/codes","births_funs.R"))
data <- read_csv(root("spc/experiments/birthdays/data", "births_usa_1969.csv"))
data <- data %>%
...
```{r singleSPC}
source(root("spc/experiments/birthdays/codes","births_model1.R"))
