...
# ------------------------------------------------------------
# Generate binary predictions from posterior draws
#
# Args:
#   X_new            : N_new × P design matrix
#   posterior_draws  : list with elements alpha and beta
#
# Returns:
#   Matrix of size N_new × S of binary draws
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Generate predictions and return probabilities
#
# Returns both binary draws and probability matrix
# Useful for log-loss or calibration diagnostics
# ------------------------------------------------------------
...
#
# Measures probabilistic predictive accuracy.
...
# Discrepancy: sample mean
mean_obs <- mean(y_all)
mean_rep <- colMeans(y_rep)

# One-sided posterior predictive p-value
ppc_pval <- mean(mean_rep > mean_obs)

# Save two-sided version
